 ...
 * HISTORIA
 *    Manuel Perez
 *    10/10/2023 Traído de IR remote control.
 *
 ****************************************************************************/
...
struct Semicycle{
    uint16_t  time;
    bool level;
    //Pin_level level; TODO: `level` NO es de tipo bool sino de tipo Pin_level
			      // con dos posibles valores: high/low o
			      // one/zero o 1/0. Pero NO es true/false!!!
};
