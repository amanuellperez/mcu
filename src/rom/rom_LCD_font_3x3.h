...
static constexpr 
atd::ROM_biarray<uint8_t, 8, bricks3x3_t1_size, ROM_read> bricks3x3_t1
	PROGMEM = {
      0b00000011,
      0b00000111,
      0b00001111,
...
struct Font_digit_3x3_t1{
    ...
    static auto brick(uint8_t i) { return big_digits::bricks3x3_t1.row(i);}
...
// Alias
using Font_digit_3x3_t1 = Big_digit<impl_of::Font_digit_3x3_t1>;
