...
constexpr mcu::Progmem_string<15> msg_cmd8_crc_error	
	PROGMEM{"CMD8 CRC error\n"};

constexpr mcu::Progmem_string<24> msg_voltage_mismatch	
	PROGMEM{"ERROR: voltage mismatch\n"};

constexpr mcu::Progmem_string<16> msg_cmd8_echo_fail	
	PROGMEM{"CMD8 echo error\n"};

constexpr mcu::Progmem_string<38> msg_acmd41_in_idle_state 
	PROGMEM{"ACMD41 fail: card still in idle state\n"};

constexpr mcu::Progmem_string<35> msg_card_no_power_up	
	PROGMEM{"CMD58 fail: card still no power up\n"};

constexpr mcu::Progmem_string<24> msg_init_SDSC_card_ok	
	PROGMEM{"Init OK: SDSC card type\n"};

constexpr mcu::Progmem_string<32> msg_init_SDHC_or_SDXC_ok 
	PROGMEM{"Init OK: SDHC or SDXC card type\n"};

constexpr mcu::Progmem_string<45> msg_go_idle_state   
	PROGMEM{"go_idle_state (cmd0) ... = entering SPI mode\n"};

constexpr mcu::Progmem_string<26> msg_send_if_cond    
	PROGMEM{"\nsend_if_cond (cmd8) ... \n"};

constexpr mcu::Progmem_string<14> msg_legacy_card	    
	PROGMEM{"\tLegacy card\n"};

constexpr mcu::Progmem_string<15> msg_vca_mismatch    
	PROGMEM{"\tVCA mismatch\n"};

constexpr mcu::Progmem_string<10> msg_cmd8_ok	    
	PROGMEM{"\tCMD8 ok\n"};

constexpr mcu::Progmem_string<44> msg_read_ocr1	    
	PROGMEM{"\nread_ocr (cmd58) ... = supported voltages?\n"};

constexpr mcu::Progmem_string<31> msg_send_op_cond    
...
constexpr mcu::Progmem_string<20> msg_invalid_r1		
	PROGMEM{"\tError: invalid r1\n"};

constexpr mcu::Progmem_string<13> msg_card_ready		
	PROGMEM{"\tCard ready\n"};

constexpr mcu::Progmem_string<16> msg_in_idle_state	
	PROGMEM{"\tIn idle state\n"};

constexpr mcu::Progmem_string<20> msg_erase_reset_error	
	PROGMEM{"\tErase reset error\n"};

constexpr mcu::Progmem_string<18> msg_illegal_command	
	PROGMEM{"\tIllegal command\n"};

constexpr mcu::Progmem_string<12> msg_crc_error		
	PROGMEM{"\tCRC error\n"};

constexpr mcu::Progmem_string<23> msg_erase_sequence_error 
	PROGMEM{"\tErase sequence error\n"};

constexpr mcu::Progmem_string<16> msg_address_error	
	PROGMEM{"\tAddress error\n"};

constexpr mcu::Progmem_string<18> msg_parameter_error	
	PROGMEM{"\tParameter error\n"};

constexpr mcu::Progmem_string<5> msg_r1	    
	PROGMEM{"\tr1["};

constexpr mcu::Progmem_string<9> msg_error1  
	PROGMEM{"] ERROR:\n"};

constexpr mcu::Progmem_string<11> msg_r3 
	PROGMEM{"\tR3     : "};

constexpr mcu::Progmem_string<12> msg_r3_response 
	PROGMEM{"R3 response\n"};

constexpr mcu::Progmem_string<30> msg_card_has_finished_power_up 
	PROGMEM{"\tCard has finished power up? "};

constexpr mcu::Progmem_string<14> msg_card_type	    
	PROGMEM{"\tCard type : "};

constexpr mcu::Progmem_string<4> msg_SDSC	    
	PROGMEM{"SDSC"};
...
constexpr mcu::Progmem_string<11> msg_r7		
	PROGMEM{"\tR7     : "};

constexpr mcu::Progmem_string<11> msg_version	
	PROGMEM{"\tVersion: "};

constexpr mcu::Progmem_string<11> msg_voltage	
	PROGMEM{"\tVoltage: "};

constexpr mcu::Progmem_string<12> msg_not_defined	    
	PROGMEM{"not defined!"};

constexpr mcu::Progmem_string<16> msg_from_2_7_to_3_6V 
	PROGMEM{"from 2.7 to 3.6V"};

constexpr mcu::Progmem_string<11> msg_low_voltage	    
	PROGMEM{"low voltage"};

constexpr mcu::Progmem_string<8> msg_reserved	    
	PROGMEM{"reserved"};
