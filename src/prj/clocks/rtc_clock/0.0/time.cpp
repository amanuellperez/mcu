...
void Main::print_time(atd::Generic_time_view<RTC::Time_point> t, uint8_t x0, uint8_t y0)
{
...
void Main::user_get_time(atd::Generic_time_view<RTC::Time_point> t, uint8_t x0, uint8_t y0)
{
