...
bool __TWI_slave_state_is_group(__TWI_slave_state a, __TWI_slave_state group)
{
    return 
...
bool __TWI_slave_state_is_busy(__TWI_slave_state a)
{
    return __TWI_slave_state_is_group(a, __TWI_slave_state::busy);
}

bool __TWI_slave_state_is_waiting(__TWI_slave_state a)
{
    return __TWI_slave_state_is_group(a, __TWI_slave_state::waiting);
}

bool __TWI_slave_state_is_listening(__TWI_slave_state a)
{
