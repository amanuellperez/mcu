...
class prueba_streambuf:public std::streambuf{
public:
...
class fix_streambuf:public std::streambuf{
public:
	...
	setp(&buffer_[0], &buffer_[0] + buffer_size); 
	setg(&buffer_[0], 0, buffer_ + buffer_size); 
    }
