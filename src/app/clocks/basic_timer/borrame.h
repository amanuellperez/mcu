...
inline bool operator==(const Converter_ms_sexagesimal& a,
	               const Converter_ms_sexagesimal& b)
{
...
struct Chronometer_ms {
    ...
    using Sexagesimal_ms = Converter_ms_sexagesimal;
